 ...
 */
export async function getTemplates(headers, session) {
 ...
 */
export async function createTemplate(headers, session, body) {
    return handlePossibleAxiosErrors(async () => {
        const { templates_web_app_table_id } = await getVariablesByName(headers, session, ["templates_web_app_table_id"]);
 ...
 * @returns A Promise of AxiosUtilsResponse<WebAppTableUpdateResponse>.
 */
export async function deleteTemplate(headers, session, id) {
    return handlePossibleAxiosErrors(async () => {
        const { templates_web_app_table_id } = await getVariablesByName(headers, session, ["templates_web_app_table_id"]);
 ...
 * @returns A Promise of AxiosUtilsResponse<WebAppTableUpdateResponse>.
 */
export async function updateTemplate(headers, session, id, body) {
    return handlePossibleAxiosErrors(async () => {
        const { templates_web_app_table_id } = await getVariablesByName(headers, session, ["templates_web_app_table_id"]);
 ...
 * @returns A Promise of AxiosUtilsResponse<WebAppTableUpdateResponse>.
 */
export async function createTemplateHistory(headers, session, body) {
    return handlePossibleAxiosErrors(async () => {
 ...
 */
export async function getTemplatesHistory(headers, session) {
    return handlePossibleAxiosErrors(async () => {
        const { history_templates_web_app_table_id } = await getVariablesByName(headers, session, ["history_templates_web_app_table_id"]);
