...
export type RejectionPercentageApplicationMode = "add" | "replace" | "successive";
...
export type PoDiscountHistoryType = "rechazo_recepcion_automatico_base" | "rechazo_recepcion_manual" | "rechazo_recepcion_manual_actualizacion" | "rechazo_cc_operativo_manual" | "rechazo_cc_operativo_manual_elotin_peso" | "rechazo_cc_operativo_manual_elotin_cantidad" | "rechazo_cc_admin_manual_reemplazo" | "rechazo_cc_admin_manual_actualizacion" | "rechazo_cc_admin_manual_descuento_masivo_reemplazo" | "rechazo_cc_admin_manual_descuento_masivo_actualizacion" | "rechazo_regla_automatica";
export type PoDiscountHistoryEntry = {
    discount: number;
    description: string;
    agency_id: number;
    employee_id: number;
...
export type PoDiscountHistory = {
    purchase_order_id: number;
    purchase_order_id_number: string;
    discounts: PoDiscountHistoryEntry[];
};
