...
const RemixServerComponent = RemixServer;
function isBotRequest(userAgent) {
    if (!userAgent)
        return false;
    return /bot|crawler|spider|crawling|facebookexternalhit|slurp|bingpreview/i.test(userAgent);
}
/**
 ...
 */
export function handleRequest(request, responseStatusCode, responseHeaders, remixContext, _loadContext) {
...
function handleBotRequest(request, responseStatusCode, responseHeaders, remixContext) {
    return new Promise((resolve, reject) => {
        ...
        const { pipe, abort } = renderToPipeableStream(createElement(RemixServerComponent, {
