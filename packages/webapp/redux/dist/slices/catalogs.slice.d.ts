import type { AgencyGraphQL, BitacoraPOMassive, BundleGraphQL, CaseGraphQL, CurrencyGraphQL, EmployeeGraphQL, FormGraphQL, FormSubmissionGraphQL, InvoiceGraphQL, ItemCategoryGraphQL, ItemGraphQL, LotStockGraphQL, MotivoRechazo, CCPorcentajeRechazo, SolicitudEliminacionPO, PesoMaximoPorCanasta, PayeeCategoryGraphQL, PayeeGraphQL, PaymentTermGraphQL, ReceptionType, ShipmentGraphQL, SuggestedPriceGraphQL, Template, TipoMuestra, WebAppRowGraphQL, PrintTemplateGraphQL, PaymentMethodGraphQL, AuthorizationUpdateDiscountPO, PoDiscountHistory, Programacion } from "@zauru-sdk/webapp-types";
export type CATALOGS_NAMES = "agencies" | "suggestedPrices" | "providers" | "providerCategories" | "receptionTypes" | "tiposDeMuestra" | "programaciones4pinos" | "motivosRechazo" | "ccPorcentajesDeRechazo" | "solicitudesEliminacionPO" | "poDiscountHistory" | "authorizationUpdateDiscountPO" | "bitacoraRechazoMasivo" | "pesoMaximoPorCanasta" | "items" | "itemsByReception" | "itemsByLab" | "itemServicesByLab" | "itemCategoriesForLab" | "payees" | "payeesForLab" | "payeeCategoriesLabPrices" | "payeeCategories" | "clientCategories" | "bundlesRecipForLab" | "currencies" | "paymentTerms" | "employeesByLab" | "employeesByCurrentAgency" | "invoicesByLab" | "invoicesByCurrentAgency" | "invoiceForms" | "caseForms" | "invoiceFormSubmissions" | "cases" | "myCaseFormSubmissions" | "allForms" | "shipmentsToMyAgency" | "myAgencyLotStocks" | "shipments" | "bookings" | "templates" | "bundlesForLab" | "paymentMethods" | "employees" | "printTemplates" | "caseFormSubmissionsByCaseId" | "invoiceFormSubmissionsByInvoiceId" | "invoiceFormSubmissionsByAgencyId";
type LoadingState<T> = {
    data: T;
    loading: boolean;
    reFetch: boolean;
...
type CatalogState = {
    ...
    solicitudesEliminacionPO: LoadingState<WebAppRowGraphQL<SolicitudEliminacionPO>[]>;
    poDiscountHistory: LoadingState<WebAppRowGraphQL<PoDiscountHistory>[]>;
    authorizationUpdateDiscountPO: LoadingState<WebAppRowGraphQL<AuthorizationUpdateDiscountPO>[]>;
