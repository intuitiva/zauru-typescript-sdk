export type FormDocumentType = "payee" | "item" | "bundle" | "entry" | "shipment" | "invoice" | "credit_note" | "payment" | "purchase_order" | "discharge" | "charge" | "reception" | "case" | "piecework" | "payroll_run" | "payroll" | "personal_time_off_request" | "work_contract" | "work_contract_termination" | "incident" | "item_category" | "employee" | "contract";
export type FormFieldType = "section" | "zauru_data" | "text" | "multi_line_text" | "number" | "percentage" | "email" | "url" | "yes_no" | "date" | "hour" | "country" | "currency" | "gt_departamentos" | "gt_municipios" | "single_select_options" | "multi_select_options" | "image" | "pdf" | "file" | "fixed_columns_table" | "fixed_rows_table";
...
declare const _default: {
    getLast100Receptions: string;
    getPayees: string;
    getItems: string;
    getPurchaseOrder: (config?: {
        withLotStocks: boolean;
    }) => string;
    getPurchaseOrdersBetweenDates: (config?: {
        agencyFilter?: boolean | undefined;
        payeeCategoryFilter?: boolean | undefined;
        itemIdFilter?: boolean | undefined;
        consolidateIdFilter?: boolean | undefined;
        lotItemIdExclusion?: number | undefined;
        poDetailTagId?: number | undefined;
        withLotStocks?: boolean | undefined;
    }) => string;
    getAgencies: string;
    getWebAppRow: string;
    getPayeeCategoryById: string;
    getPayeeById: string;
    getSuperCategoryById: string;
    getItemCategoryById: string;
    getConsolidatesBetweenDates: string;
    getWebAppRowsByWebAppTableId: string;
    getPurchaseOrderByIdNumber: string;
    getItemsByCategory: string;
    getItemsBySuperCategory: string;
    getEmployeeProfile: string;
    getBundlesByItemCategoryId: string;
    getItemByName: string;
    getFormByName: string;
    getBundleByName: string;
    getPayeeCategoriesByNotesMatch: (match: string) => string;
    getPayeeCategories: string;
    getProviderCategories: string;
    getCurrencies: string;
    getSuggestedPrices: (config?: {
        notNullPriceList: boolean;
        withItems: boolean;
        withItemCategories: boolean;
    }) => string;
    getPaymentTerms: string;
    getEmployeesByAgencyId: string;
    getInvoicesByAgencyId: string;
    getForms: string;
    getFormsByDocumentType: (filters?: {
        formZid?: number | undefined;
    }) => string;
    getInvoiceFormSubmissionsByAgencyId: (filters?: {
        seller_id?: string | number | undefined;
        payee_id_number_search?: string | undefined;
        some_field_value?: string | undefined;
        item_ids?: number[] | undefined;
        bundle_ids?: number[] | undefined;
        startDate?: string | undefined;
        endDate?: string | undefined;
    } | undefined) => string;
    getInvoiceFormSubmissionsByInvoiceId: (filters?: {
        formZid?: number | undefined;
    }) => string;
    getPaymentTermById: string;
    getProviders: string;
    getCasesByResponsibleId: (wheres?: string[]) => string;
    getMyCaseFormSubmissions: (filters?: {
        formZid?: number | undefined;
        caseId?: number | undefined;
    }) => string;
    getClientCategories: string;
    getShipmentsByToAgencyLast100: string;
    getLotsByName: string;
    getFormSubmissionById: string;
    getLastInvoiceFormSubmission: (filters?: {
        formZid?: number | undefined;
    }) => string;
    getLotStocksByAgencyId: string;
    getShipments: (wheres?: string[]) => string;
};
